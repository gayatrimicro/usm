        ...
        <div id="panes">
          <div style="margin-top:0px;  border-top: 0px solid #ECECEC; float:left;padding: 0px 0 24px;" id="b1">
            	<div class="offset-by-one six columns" >
                 <h3 style="padding-left:0px;">Geo text</h3>
            		<p>The Geo text is suitable for any kind of bags, closed either by sewing or heat sealing, as well as for valve bags, independent of the kind of bag material. 
</p>
