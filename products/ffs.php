...
available), optional reject mechanisms, and accuracy to + 0.5 gram</p>
 <p style="margin-top:15px;" class="btn-primary1 btn_pos"><span class="pos_abso" onclick="get_num(0)"></span><a href="pdf/Check-Weighers.pdf" target="_blank" class="btn btn-large btn-primary btn_1">Download catalogue<span class="icon-preventivo"> </span></a></p>
                </div>
...
efficiency, speed and versatility.</p>
 <p style="margin-top:15px;" class="btn-primary1 btn_pos"><span class="pos_abso" onclick="get_num(1)"></span><a href="pdf/Weigher-FFS-Final.pdf" target="_blank" class="btn btn-large btn-primary btn_1">Download catalogue<span class="icon-preventivo"> </span></a></p>
                </div>
